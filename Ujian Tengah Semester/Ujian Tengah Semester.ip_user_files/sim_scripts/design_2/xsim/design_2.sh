...
#
# Generated by Vivado on Tue Mar 22 22:27:50 +0700 2022
...
# Script info
echo -e "design_2.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_2 xil_defaultlib.design_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim design_2 -key {Behavioral:sim_1:Functional:design_2} -tclbatch cmd.tcl -log simulate.log
}
